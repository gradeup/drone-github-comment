...
func main() {
	...
	DRONE_ACCESS_TOKEN := os.Getenv("PLUGIN_DRONE_ACCESS_TOKEN")
	DRONE_HOST := os.Getenv("DRONE_SYSTEM_HOST")
	DRONE_BUILD_NUMBER := os.Getenv("DRONE_BUILD_NUMBER")
	GITHUB_INSTALLATION_ID := os.Getenv("PLUGIN_GITHUB_INSTALLATION_ID")
	GITHUB_APP_ID := os.Getenv("PLUGIN_GITHUB_APP_ID")
	PRIVATE_KEY := os.Getenv("PLUGIN_PRIVATE_KEY")
